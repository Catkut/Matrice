...
class GridItem extends React.Component  {
    ...
    componentDidUpdate() {
        console.log("update nb emoji: ", this.getNumberOfEmojis());
    }
...
/*
    ...
    handleAdd = () => {
        console.log("entering handleass...")
            ...
            <div className="garden">
                <div className="garden-grid">
                    {this.state.garden.map((plant, index) => {
                        return (
                            <button className="garden-cell" onClick={this.props.actionDelete} key={index} id={index}>
                            {plant.value}</button>
                        );
                    })}
                </div>
                <button className="button-action" onClick={() => this.handleAdd} >Plant a Emoji</button>
           </div>
        )
    }
}
